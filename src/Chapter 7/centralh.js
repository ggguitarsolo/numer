...
render() {
    return (
      <div>
          ...
          <Breadcrumb.Item>Lesson 6</Breadcrumb.Item>
          <Breadcrumb.Item>Central O(h<sup>2</sup>)</Breadcrumb.Item>
          </Breadcrumb>
          <Content style={{
            ...
            <Row type="flex" justify="space-around" align="middle">
              <Col span={6} style={{minWidth: 60}}>
                <div onChange={this.handleChange}>
                  ...
                  <Button id='submit' onClick={ ()=>this.centralh(parseFloat(this.state.x), parseFloat(this.state.h), parseInt(this.state.degree))} 
