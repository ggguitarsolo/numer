        ...
        return (
            <Layout style={{ padding: '0 12px 12px' }}>
                <Breadcrumb style={{ margin: '36px 0' }}>
                    <Breadcrumb.Item><center><h2>One-Point Iteration Method</h2> </center></Breadcrumb.Item>
                </Breadcrumb>
                <Content
                    ...
                    <div width={10000} className="has-text-centered">
                        ...
                        <Form>
                            ...
                            <div>
                                ...
                                <Button variant="dashed" href="/Onepoint" style={{ backgroundColor: '#F9A8A8' }}> CLEAR  </Button>
